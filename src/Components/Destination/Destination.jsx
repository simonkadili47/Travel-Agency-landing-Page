...
function Destination() {
  const renderCard = (image, location, place, days, price) => (
    <div className='flex flex-col items-start  border rounded-lg px-1 py-1 mt-4'>
      <img src={image} alt="" className='w-auto   h-36 object-cover rounded-t-lg' />
      <div className=' w-40  pb-2 mt-2'>
        ...
        <p className='mt-3 pl-2 text-start text-md font-bold'>{place}</p>
